...
:::message
**検証環境**: Obsidian + n8n（セルフホスト）+ Supabase（pgvector）+ Anthropic API（2026年5月時点）。月次コストは数千円以内。各ツールの仕様・価格は変動するので、ポートやモデル・価格は[公式](https://supabase.com/docs/guides/ai)で最新を確認してほしい。
:::
